    ...
    <>
      <header>
        <nav>
          ...
          <a href="https://simplecss.org/demo" class="current">
            Demo
          </a>

          <a href="https://simplecss.org/news">News</a>

          <a href="https://github.com/kevquirk/simple.css">
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>&lt;p class="notice"&gt;This is a notice box. It's useful for calling out snippets of information. Cool, huh?&lt;/p&gt;
</code></pre></div></div>
...
<p><img src={dogImage} alt="A dog at an iPad" width="1000" height="667" /></p>

<figure>
  <img alt="This is a black swan" src={gooseImage} width="1000" height="663"  />
...
<p>If your table is too wide to fit on the page, wrap it in a <code class="language-plaintext highlighter-rouge">&lt;figure&gt;</code> element to add horizontal scrolling:</p>
...
<form>
  ...
  <label><input checked name="type" type="radio" value="sales" /> Sales</label> 
  ...
  <button>Send</button> <button type="reset">Reset</button> <button disabled>Disabled</button>
</form>
